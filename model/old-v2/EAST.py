...
class EAST(nn.Module):
    ...
    def forward(self, x):
        ...
        h1 = F.interpolate(F1, scale_factor=2, mode='bilinear', align_corners=True)
...
print("Input shape: ", eee.shape)
model = EAST(color_channel=1,scale_factor=4, img_width=640, img_height=360)
